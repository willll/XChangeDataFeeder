...
public class BtccFactory extends GenericFactory {
	...
	public static void btcc(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getBtccFactory();
	...
	public String getCurrencyPairs() {
		return Constants.btcc_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.btcc_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.btcc_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.btcc_refresh_rate;
	}
}