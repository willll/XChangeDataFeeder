...
public class AcxFactory extends GenericFactory {
	...
	public static void acx(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getAcxFactory();
	...
	public String getCurrencyPairs() {
		return Constants.acx_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.acx_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.acx_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.acx_refresh_rate;
	}
}