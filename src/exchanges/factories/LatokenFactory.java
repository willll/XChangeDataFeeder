...
public class LatokenFactory extends GenericFactory {
	...
	public static void latoken(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getLatokenFactory();
	...
	public String getEnabled() {
		return Constants.latoken_enabled;
	}
	...
	public String getCurrencyPairs() {
		return Constants.latoken_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.latoken_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.latoken_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.latoken_refresh_rate;
	}
}