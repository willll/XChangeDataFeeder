...
public class HuobiFactory extends GenericFactory {
	...
	public static void huobi(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getHuobiFactory();
	...
	public String getEnabled() {
		return Constants.huobi_enabled;
	}
	...
	public String getCurrencyPairs() {
		return Constants.huobi_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.huobi_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.huobi_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.huobi_refresh_rate;
	}
}