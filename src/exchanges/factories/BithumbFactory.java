...
public class BithumbFactory extends GenericFactory {
	...
	public static void bithumb(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getBithumbFactory();
	...
	public String getEnabled() {
		return Constants.bithumb_enabled;
	}
	...
	public String getCurrencyPairs() {
		return Constants.bithumb_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.bithumb_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.bithumb_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.bithumb_refresh_rate;
	}
}