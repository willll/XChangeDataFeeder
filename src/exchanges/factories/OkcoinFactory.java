...
public class OkcoinFactory extends GenericStreamingFactory {
	...
	public static void OkCoin(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericStreamingFactory gf_ = ExchangesFactory.getOkcoinFactory();
	...
	public String getEnabled() {
		return Constants.OkCoin_enabled;
	}
	...
	public String getCurrencyPairs() {
		return Constants.OkCoin_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.OkCoin_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.OkCoin_orderbook_enabled;
	}
}