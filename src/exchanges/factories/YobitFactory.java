...
public class YobitFactory extends GenericFactory {
	...
	public static void YoBit(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getYobitFactory();
	...
	public String getEnabled() {
		return Constants.YoBit_enabled;
	}
	...
	public String getCurrencyPairs() {
		return Constants.YoBit_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.YoBit_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.YoBit_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.YoBit_refresh_rate;
	}
}