...
public class ExmoFactory extends GenericFactory {
	...
	public static void exmo(Boolean _listCmd, EntryPoint _ep, Set<CurrencyPair> _cp, ArrayList<Thread> _thds,
		...
		GenericFactory gf_ = ExchangesFactory.getExmoFactory();
	...
	public String getCurrencyPairs() {
		return Constants.exmo_currency_pairs;
	}
	...
	public String getTickerEnabled() {
		return Constants.exmo_ticker_enabled;
	}
	...
	public String getOrderbookEnabled() {
		return Constants.exmo_orderbook_enabled;
	}
	...
	public String getRefreshRate() {
		return Constants.exmo_refresh_rate;
	}
}